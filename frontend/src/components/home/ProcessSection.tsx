          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-24">
              ...
              <p className="font-manrope font-light text-lg text-[#4b5563] mb-8 leading-relaxed">
                We've simplified the complex journey of buying a home into four seamless,
                professional steps.
              </p>
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div>
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-syne font-bold text-2xl text-[#111827] mb-3">Requirement Analysis</h3>
                  <p className="font-manrope text-base text-[#4b5563] leading-relaxed">
                    We dive into your preferences, lifestyle needs, and financial goals to build a comprehensive
                    buyer profile.
                  </p>
                </div>
              </div>
            ...
            <div>
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="font-syne font-bold text-2xl text-[#111827] mb-3">Verified Selection</h3>
                  <p className="font-manrope text-base text-[#4b5563] leading-relaxed">
                    We scan thousands of listings to find properties that align with your unique criteria, filtering out
                    the noise for you.
                  </p>
                </div>
              </div>
